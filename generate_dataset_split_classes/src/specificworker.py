...
class SpecificWorker(GenericWorker):
      ...
      # Video
      pathVideo = "/media/robocomp/externalDisk/leftCameraVideo1.bag"        # The path of the video we will be reading
      pipeline = None         # Pipeline to connect with the video and request
      configuration = None    # Configuration of the pipeline
      
      # Dataset
      pathDatasetFolderColorFrames = "/home/robocomp/dataset/colorFrames"              # The folder where the dataset will be saved
      pathDatasetFolderDepthFrames = "/home/robocomp/dataset/depthFrames"
      counterFrames = None
      ...
      def __del__(self):
            ...
            """
            # There isn´t reasons to give output results when there aren´t frames readed by programme.
      ...
      def check_conditions (self):
            ...
            if not (os.path.isdir (self.pathDatasetFolderDepthFrames) and (not any (os.listdir(self.pathDatasetFolderDepthFrames)))):
                  sys.exit ("FAILURE (2): pathDatasetFolderDepthFrames isn´t correct. Check the method check_conditions (self)")
            ...
            if not (os.path.isfile (self.pathVideo) and extensionVideoFile == "bag"):
                  sys.exit ("FAILURE (3): pathVideo isn´t correct. Check the method check_conditions (self)")
      ...
      def data_to_user (self):
            ...
            print ("Number of frames saved:", str (self.counterFrames))
